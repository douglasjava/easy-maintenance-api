    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/easy-maintenance/api/v1/auth/2fa/verify").permitAll()
                        .requestMatchers("/easy-maintenance/api/v1/auth/2fa/request-recovery").permitAll()
                        .requestMatchers("/easy-maintenance/api/v1/auth/2fa/apply-recovery").permitAll()
